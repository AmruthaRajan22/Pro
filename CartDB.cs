                ...
                case UnityWebRequest.Result.Success:
                    ...
                    for(int i = 0; i < users.Length; i++)
                    {
                        ...
                        if(users[i] != "")
                        {
                            ...
                            Debug.Log("Quamtity: " + userinfo[0] + "Price : " + userinfo[1] + "ProductName : " + userinfo[2]);
                            ...
                            */
                            ...
                            gobj.GetComponent<CartInfo>().quantity.text = userinfo[0];
                            gobj.GetComponent<CartInfo>().price.text = userinfo[1];    
                            gobj.GetComponent<CartInfo>().productName.text = userinfo[2];                            
